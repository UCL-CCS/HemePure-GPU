  ...
  namespace geometry
  {
    namespace decomposition
    {
      ...
      */
      ...
      static const int hemelbSiteWeights[6] = { hemelbSiteWeightsNEUTRAL, 
                                                hemelbSiteWeightsSIMPLEBOUNCEBACK_NEUTRAL, 
                                                hemelbSiteWeightsLADDIOLET_NEUTRAL, 
                                                hemelbSiteWeightsNASHZEROTHORDERPRESSUREIOLET_NEUTRAL, 
                                                hemelbSiteWeightsLADDIOLET_NEUTRAL, 
                                                hemelbSiteWeightsNASHZEROTHORDERPRESSUREIOLET_NEUTRAL };
