...
//-------------------
    ...
    //bool LocalDistributionInput::Set_checkpointing_Get_Distr_To_Host(geometry::LatticeData* latDat)
    bool LocalDistributionInput::Set_checkpointing_Get_Distr_To_Host()
    {
...
//------------------
    ...
    void LocalDistributionInput::LoadDistribution(geometry::LatticeData* latDat, boost::optional<LatticeTimeStep>& targetTime)
    {
      ...
      std::cout << "filePath in LocalDistributionInput is: " << filePath;
