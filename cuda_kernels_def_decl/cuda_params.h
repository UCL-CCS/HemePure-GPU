...
//#ifdef HEMELB_USE_GPU
	...
	__global__ void GPU_CollideStream_2(double* GMem_dbl_fOld_b, double* GMem_dbl_fNew_b, double* GMem_dbl_MacroVars, int64_t* GMem_int64_Neigh, uint32_t* GMem_uint32_Wall_Link, uint64_t nArr_dbl, uint64_t lower_limit, uint64_t upper_limit, uint64_t totalSharedFs);
